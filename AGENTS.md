...
10. Phase 8B exact-duplicate consolidation, conservative RAW/JPEG reconciliation, preferred-representation failover, and multi-representation review are implemented; Phase 8 semantic embeddings/search is the next phase.
