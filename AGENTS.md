...
- Phase 10A validates an actual `libjxl` runtime through `imagecodecs`, app-owned JPEG XL display-preview provenance, and external JXL representation handling. Production JXL/AVIF encoding and source mutation remain deferred until the executor safety contract is accepted.
